...
def _write_json(rows: list[dict]) -> None:
    payload = {
        ...
        "title": "HammerDB Community Leaderboard",
        "disclaimer": [
            "Community-submitted HammerDB results",
            "Unaudited",
            "Not official TPC benchmark results",
            "Generated from GitHub-reviewed HammerDB summaryjson artifacts",
            "Intended for later publication/consumption by the TPC website",
        ],
        "rows": rows,
    }
...
<head>
  ...
  <title>HammerDB Community Leaderboard</title>
  <style>
...
<body>
  <h1>HammerDB Community Leaderboard</h1>
  <div class=\"messages\">
    <p>Community-submitted HammerDB results</p>
    <p>Unaudited</p>
    <p>Not official TPC benchmark results</p>
    <p>Generated from GitHub-reviewed HammerDB summaryjson artifacts</p>
    <p>Intended for later publication/consumption by the TPC website</p>
  </div>
  <div class=\"scroll\">
    <table>
