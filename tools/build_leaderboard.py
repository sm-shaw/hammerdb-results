...
<style>:root{{--bg:#fff;--line:#dbe4f0;--muted:#64748b;--blue:#2563eb}}*{{box-sizing:border-box}}body{{margin:0;background:var(--bg);font-family:Inter,Segoe UI,Arial,sans-serif;color:#0f172a}}
.wrap{{max-width:1220px;margin:0 auto;padding:0 20px 28px}}.hero{{background:#fff;color:#0f172a;padding:22px 0 30px;margin-bottom:22px;border-bottom:1px solid var(--line)}}
.brandbar{{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;margin-bottom:14px}}.brand-left{{display:flex;align-items:flex-end;gap:18px}}.brand-hammerdb{{height:62px;width:auto;display:block}}.brand-tpc{{height:62px;width:auto;display:block;margin-top:0}}
.hero h1{{margin:0;font-size:2.2rem}}.hero p{{max-width:780px;color:#334155}}.badges{{display:flex;gap:8px;flex-wrap:wrap;margin:12px 0 0}}.badge{{padding:6px 12px;border-radius:999px;background:#eef4ff;border:1px solid #d5e3ff;color:#25407a;font-weight:600;font-size:.84rem}}
.warn{{margin-top:16px;padding:12px 14px;border-radius:12px;background:#fff7ed;border:1px solid #fdba74;color:#9a3412;font-weight:500}}
...
.btn{{display:inline-block;background:#111827;color:#fff;text-decoration:none;padding:9px 12px;border-radius:10px;font-weight:700}}.star{{color:#facc15;margin-right:4px}}.stats{{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin:16px 0 20px}}
